...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerRoster = function (_React$Component2) {
		...
		_createClass(PlayerRoster, [{
			...
			value: function componentDidMount() {
				...
				_axios2.default.get('/roster').then(function (res) {
					_this4.setState({ players: res.players });
				});
			}
		}, {
			key: "render",
	...
	var PlayerLists = function (_React$Component3) {
		...
		function PlayerLists() {
			...
			var _this5 = _possibleConstructorReturn(this, (PlayerLists.__proto__ || Object.getPrototypeOf(PlayerLists)).call(this));

			_this5.state = {
				selectedIds: []
			};
			_this5.addPlayer = _this5.addPlayer.bind(_this5);
			_this5.removePlayer = _this5.removePlayer.bind(_this5);
			return _this5;
		}
